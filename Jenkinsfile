pipeline {
  ...
  post {
      success {
        script {
           sh "curl -XPOST -H \"Authorization: Basic amVmZmY6KioqKioqKio=\" \"https://partnership-pipelines-api.jfrog.io/v1/projectIntegrations/17/hook\" -d '{\"buildName\":\"gociexample_build\",\"buildNumber\":\"$BUILD_NUMBER\",\"buildInfoResourceName\":\"jenkinsBuildInfo\"}' -H \"Content-Type: application/json\""
        }
      }
  }
}